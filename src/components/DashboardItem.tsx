      ...
      <TouchableOpacity style={[styles.touchableStyle]} onPress={action}>
        <View style={styles.row}>
          <View style={{flexDirection: 'row', alignItems: 'center'}}>
            ...
            {icon[0] == 'Icon2' && (
              <Icon2 name={icon[1]} color={theme.colors.primary} size={35} />
            )}
            {icon[0] == 'Icon3' && (
              <Icon3 name={icon[1]} color={theme.colors.primary} size={35} />
            )}
          </View>
          <View
            style={{
            ...
            <Text
              style={[
                defaultStyles.text,
                {fontWeight: 'bold', fontSize: 20, color: theme.colors.primary},
              ]}>
              {item.title}
            </Text>
          </View>
