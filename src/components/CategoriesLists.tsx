...
type AddCategoryProps = StackNavigationProp<
...
const CategoriesLists = ({category, color}: Props) => {
  const {t} = useTranslation();
  const {ColorPallet} = useTheme();
  const navigation = useNavigation<AddCategoryProps>();
  ...
  const handleEdit = () => {
    navigation.navigate('AddCategory', {item: category, isEditing: true});
  };
  ...
  return (
    <View style={styles.orderCard}>
      <Text style={styles.customer}>
        <Text style={styles.orderId}>{t('AddCategory.NameFr')} : </Text>
        {category.nameFr}
      </Text>
      <Text style={styles.customer}>
        <Text style={styles.orderId}>{t('AddCategory.NameEn')} : </Text>
        {category.nameEn}
      </Text>
