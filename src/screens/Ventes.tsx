...
export const Ventes = () => {
  ...
  const [accesRight, setAccesRight] = useState(false);
      ...
      .onSnapshot(querySnapshot => {
        if (querySnapshot.empty) {
          ...
          querySnapshot.forEach(documentSnapshot => {
            const eventData = documentSnapshot.data() as Vendeur;
            console.log(eventData);
            setAccesRight(eventData.actif);
            setExiste(eventData.actif);
          });
        }
      });
      ...
      return (
        <SafeAreaView style={{flex: 1, paddingTop: 20}}>
          ...
          <View
            ...
            <Paragraph>
              {
                'Vous allez acceder a votre espace une fois que votre formulaire est été validée'
              }
            </Paragraph>
          </View>
        </SafeAreaView>
